...
\lstinputlisting[caption={Raw textfile containing the unrounded numerical values for the fitting parameters presented in Table \ref{tab:fit_vals}. The column names are the same as there.}]{results/full_fitresults.txt}
\newpage
